...
public:
	...
	/* Identifikadore berri bat sortzen du, "%t1, %t2, ..." modukoa eta beti desberdina. */
	std::string idBerria() ;
	...
	void erazagupenakGehitu(const IdLista &idIzenak, const std::string &motaIzena);

	/* Parametro zerrenda, parametro mora eta mota emanda parametro erazagupen aginduak sortu eta gehitu */
	void parametroakGehitu(const IdLista &idIzenak, const std::string &parMotaIzena, const std::string &motaIzena) ;
